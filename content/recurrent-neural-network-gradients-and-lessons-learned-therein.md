...
In all posts, I think the authors unfortunately blur the line between
...
Note the opposing definitions of the variable $\frac{\partial J^{t=2}}{\partial w^{xh}_{mi}}$. As far as I know, the latter is,
