...
![]({filename}figures/empirical_distribution_explicit_feedback_scores.png)
...
![]({filename}figures/mean_posterior_cumulative_distribution.png)
...
![]({filename}figures/comparative_posterior_predictive_density_plots.png)
...
![]({filename}figures/comparative_posterior_cumulative_distributions.png)
...
![]({filename}figures/a_b_comparison_plot.png)
