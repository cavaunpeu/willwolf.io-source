...
For the OSMLM, give special thought to *computer* insurance as well: without you're computer, there's not a whole lot of work that you can do.
...
In 2016, in addition to further technical expertise in ML, I wanted to both ~perfect my French, and live in an Arab country. Pursuing the OSMLM in Casablanca allowed me to pursue all three goals simultaneously.
...
2. **You become a pseudo-expert in machine learning**. Perhaps with another spoken language under your belt, or having lived abroad for the first time. You're energized, refreshed, and ready to return to a new job (or join the field for the first time). You have stories, and portfolio of work, that make others envious. **Assuming that you did put in the effort, this is at once your worst-case, and best-case, scenario.**
